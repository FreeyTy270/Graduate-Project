...
void txm_Task(void * pvParameters)
{
	...
	while(1)
	{
		if(pkgRdy_flg)
		{
			...
			if(xQueueReceive(buffer_mbx, rec, 0) != pdTRUE) trans_rx_fail++; // Receive data buffer from mailbox
